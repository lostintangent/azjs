 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
HostingEnvironments.prototype.getHostingEnvironmentCapacitiesNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
HostingEnvironments.prototype.getHostingEnvironmentsNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
HostingEnvironments.prototype.getHostingEnvironmentMetricsNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
HostingEnvironments.prototype.getHostingEnvironmentUsagesNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
HostingEnvironments.prototype.getHostingEnvironmentMultiRoleMetricsNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
HostingEnvironments.prototype.getHostingEnvironmentWebWorkerMetricsNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
HostingEnvironments.prototype.getHostingEnvironmentMultiRoleMetricDefinitionsNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
HostingEnvironments.prototype.getHostingEnvironmentWebWorkerMetricDefinitionsNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
HostingEnvironments.prototype.getHostingEnvironmentMultiRoleUsagesNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
HostingEnvironments.prototype.getHostingEnvironmentWebWorkerUsagesNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
HostingEnvironments.prototype.getHostingEnvironmentSitesNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
HostingEnvironments.prototype.getHostingEnvironmentWebHostingPlansNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
HostingEnvironments.prototype.getHostingEnvironmentServerFarmsNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
HostingEnvironments.prototype.getMultiRolePoolsNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
HostingEnvironments.prototype.getMultiRolePoolSkusNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
HostingEnvironments.prototype.getWorkerPoolsNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
HostingEnvironments.prototype.getWorkerPoolSkusNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
HostingEnvironments.prototype.suspendHostingEnvironmentNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Send request
  this.beginSuspendHostingEnvironmentNext(nextPageLink, options, function (err, parsedResult, httpRequest, response){
    if (err) return callback(err);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
HostingEnvironments.prototype.beginSuspendHostingEnvironmentNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
HostingEnvironments.prototype.resumeHostingEnvironmentNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Send request
  this.beginResumeHostingEnvironmentNext(nextPageLink, options, function (err, parsedResult, httpRequest, response){
    if (err) return callback(err);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
HostingEnvironments.prototype.beginResumeHostingEnvironmentNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
