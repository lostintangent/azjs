 ...
 *
 */
function PolicyClient(credentials, subscriptionId, baseUri, options) {
  ...
  PolicyClient['super_'].call(this, credentials, options);
...
util.inherits(PolicyClient, ServiceClient);
