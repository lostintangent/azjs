...
Resources.prototype.beginMoveResources = function (sourceResourceGroupName, parameters, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{sourceResourceGroupName}/moveResources';
...
Resources.prototype.list = function (options, callback) {
  ...
  // Construct URL
  var baseUrl = this.client.baseUri;
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resources';
  requestUrl = requestUrl.replace('{subscriptionId}', encodeURIComponent(this.client.subscriptionId));
  var queryParameters = [];
...
Resources.prototype.checkExistence = function (resourceGroupName, resourceProviderNamespace, parentResourcePath, resourceType, resourceName, apiVersion, options, callback) {
  ...
  // Construct URL
  var baseUrl = this.client.baseUri;
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{parentResourcePath}/{resourceType}/{resourceName}';
...
Resources.prototype.deleteMethod = function (resourceGroupName, resourceProviderNamespace, parentResourcePath, resourceType, resourceName, apiVersion, options, callback) {
  ...
  // Send request
  this.beginDeleteMethod(resourceGroupName, resourceProviderNamespace, parentResourcePath, resourceType, resourceName, apiVersion, options, function (err, parsedResult, httpRequest, response){
    if (err) return callback(err);
...
Resources.prototype.createOrUpdate = function (resourceGroupName, resourceProviderNamespace, parentResourcePath, resourceType, resourceName, apiVersion, parameters, options, callback) {
  ...
  // Send request
  this.beginCreateOrUpdate(resourceGroupName, resourceProviderNamespace, parentResourcePath, resourceType, resourceName, apiVersion, parameters, options, function (err, parsedResult, httpRequest, response){
    if (err) return callback(err);
...
Resources.prototype.checkExistenceById = function (resourceId, apiVersion, options, callback) {
  ...
  // Construct URL
  var baseUrl = this.client.baseUri;
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + '{resourceId}';
...
Resources.prototype.deleteById = function (resourceId, apiVersion, options, callback) {
  ...
  // Send request
  this.beginDeleteById(resourceId, apiVersion, options, function (err, parsedResult, httpRequest, response){
    if (err) return callback(err);
...
Resources.prototype.createOrUpdateById = function (resourceId, apiVersion, parameters, options, callback) {
  ...
  // Send request
  this.beginCreateOrUpdateById(resourceId, apiVersion, parameters, options, function (err, parsedResult, httpRequest, response){
    if (err) return callback(err);
