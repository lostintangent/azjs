    ...
    return new Promise((resolve, reject) => {
        ...
        if (clientId && clientSecret && tenantId) {
            try {
                ...
                reject(new Error("The Azure credentials specified via environment variables don't appear to be valid. Please check them and try authenticating again"));
            }
        } else {
...
exports.login = async () => {
    const { credentials, interactive, subscriptions } = await authenticate();
